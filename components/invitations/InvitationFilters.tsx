 ...
 * Provides filtering controls for invitation list
 */
...
export function InvitationFilters({ onFilterChange, departments }: InvitationFiltersProps) {
  ...
  }, [status, debouncedSearch, department, onFilterChange]);
  ...
  const hasActiveFilters = search || status !== 'all' || department !== 'all';
